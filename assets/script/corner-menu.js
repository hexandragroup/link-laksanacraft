(function(){
  ...
  style.textContent = `
    .corner-tab { position: fixed; top:30px; right:-10px; width:55px; height:55px;
    ...
    .corner-menu { position:fixed; top:0; right:-180px; width:180px; height:100%;
      background: rgba(255,255,255,0.95); box-shadow: -3px 0 12px rgba(0,0,0,0.2);
      display:flex; flex-direction:column; padding-top:60px; transition:right 0.3s ease; z-index:9999; }
    .corner-menu.show { right:0; }
    .corner-menu a { padding:12px 20px; border-bottom:1px solid rgba(0,0,0,0.1);
